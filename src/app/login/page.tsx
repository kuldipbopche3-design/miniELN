      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white shadow-xl z-10 border-r border-zinc-200">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight text-zinc-900">Sign in to your lab</h2>
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-indigo-700 via-indigo-900 to-emerald-900 flex flex-col justify-between p-16 text-white">
          ...
          <div className="space-y-6 max-w-xl">
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
              Organize your experiments. Share findings. Accelerate discovery.
            </h1>
            <p className="text-zinc-300 text-lg leading-relaxed">
              LabFlow brings Notion-like organization to small labs. Track testing samples, upload analytical files, export clean PDFs, and collaborate in a secure workspace.
            </p>
          </div>
